            ...
            <form name="project" enctype="multipart/form-data">
                <?php
                    switch ( $type_project )
                    {
                        default:
                        case 'sale':
                            echo $this->format->get_file( Security::DS(PATH_ADMINISTRATOR_LAYOUTS . 'Projects/tpl_form_project_sale.php'), ['count_slideshow' => $count_slideshow] );
                            break;

                        case 'under_construction':
                            echo $this->format->get_file( Security::DS(PATH_ADMINISTRATOR_LAYOUTS . 'Projects/tpl_form_project_under_construction.php'), ['count_slideshow' => $count_slideshow] );
                            break;

                        case 'finished':
                            echo $this->format->get_file( Security::DS(PATH_ADMINISTRATOR_LAYOUTS . 'Projects/tpl_form_project_finished.php'), ['count_slideshow' => $count_slideshow] );
                            break;
                    }
                ?>
            </form>
